...
Feature: Login page of conduit
  ...
  Scenario Outline: Login with invalid userid and password
    ...
    @tag3
  Scenario Outline: click on My articles tab and favorited articles tab
    Given I should be at the login page
    And I provide valid userid and password
    When I click on sign in button
    Then I should be able to login inside conduit
    And I should be able to click on my articles tab
    And I should be able to click on favorited articles

    @tag4
  Scenario Outline: Post new feed on the page
    Given I should be at the login page
    And I provide valid userid and password
    When I click on sign in button
    Then I should be able to login inside conduit
   ...
   @tag5
  Scenario Outline: Post new article on the page and post message comment
    Given I should be at the login page
    And I provide valid userid and password
    When I click on sign in button
    Then I should be able to login inside conduit
